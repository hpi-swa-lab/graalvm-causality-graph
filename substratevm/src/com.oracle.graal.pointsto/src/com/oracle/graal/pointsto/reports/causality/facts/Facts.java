...
public final class Facts {
    ...
    public static final Fact AutomaticFeatureRegistration = new RootFact(FactKinds.AutomaticFeatureRegistration);
    public static final Fact UserEnabledFeatureRegistration = new RootFact(FactKinds.UserRequestedFeatureRegistration);
    public static final Fact InitialRegistration = new RootFact(FactKinds.InitialRegistrations);
    public static final Fact StructualProperty = new RootFact(FactKinds.StructuralProperty);
